...
if(message.content == (prefix + "serverbots")) {
...
.setTimestamp()
.setColor('#fdff00')
message.channel.send(`> 🔸 - List Server:`);
...
client.on('message' , async (message) => {
  ...
  let invites = await message.guild.fetchInvites();
    ...
    .addField('> 🔸 - inviter:' , `\`\`\`${table.table(possibleInvites)}\`\`\``)
...
client.login("NjAyNzEwNzM1NzEzNDY4NDM4.XfcX1g.qsoLmH03bn4N3AIKVQEACwcsiPk");
